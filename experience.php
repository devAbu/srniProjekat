...
<body>
    ...
    <section>
        <div class="container">
            <h2 class="experienceTitle">High School</h2>
            <p>Tursko-bosanski college</p>

            <h2 class="experienceTitle">University</h2>
            <p> <a href="https://www.ius.edu.ba/"> IUS</a></p>

            <h2 class="experienceTitle">Skills</h2>
            <p>
                <span>HTML</span>
                <span>CSS</span>
                <span>JS</span>
