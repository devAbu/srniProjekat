...
<body>
    ...
    <section>
        <div class="container">
            <h2 id="aboutTitle" class="mb-3">About me</h2>
            <p id="aboutText">Lorem ipsum dolor sit amet,sed diam nonumy eirmod tempor invidunt ut labore et dolore
                magna aliquyam
                erat,
                ...
                ipsum
                dolor sit amet. no sea takimata sanctus est Lorem ipsum dolor sit amet. no sea takimata sanctus est
                Lorem
                ipsum dolor sit amet. sed diam voluptua. </p>

            <img src="images/tvojaSlika.jpg" class="mb-3" alt="tvojaSlika"> <br>
            <a href="linkCV-a" id="linkAbout">Dodaj CV</a>
        </div>
    </section>
